...
class KHistory(models.Model):
    ...
    maxPE = models.CharField(max_length=255, blank=True, null=True, verbose_name="近十年最高市盈率")
    minPE = models.CharField(max_length=255, blank=True, null=True, verbose_name="近十年最低市盈率")
